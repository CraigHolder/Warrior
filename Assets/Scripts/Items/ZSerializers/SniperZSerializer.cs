[System.Serializable]
public sealed class SniperZSerializer : ZSerializer.Internal.ZSerializer
{
    ...
    public SniperZSerializer(string ZUID, string GOZUID) : base(ZUID, GOZUID)
    {       var instance = ZSerializer.ZSerialize.idMap[ZSerializer.ZSerialize.CurrentGroupID][ZUID];
         bulletRot = (UnityEngine.Transform)typeof(Sniper).GetField("bulletRot").GetValue(instance);
    ...
    {
         typeof(Sniper).GetField("bulletRot").SetValue(component, bulletRot);
