[System.Serializable]
public sealed class BowZSerializer : ZSerializer.Internal.ZSerializer
{
    ...
    public BowZSerializer(string ZUID, string GOZUID) : base(ZUID, GOZUID)
    {       var instance = ZSerializer.ZSerialize.idMap[ZSerializer.ZSerialize.CurrentGroupID][ZUID];
         bulletRot = (UnityEngine.Transform)typeof(Bow).GetField("bulletRot").GetValue(instance);
    ...
    {
         typeof(Bow).GetField("bulletRot").SetValue(component, bulletRot);
