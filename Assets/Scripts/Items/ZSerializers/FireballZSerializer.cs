[System.Serializable]
public sealed class FireballZSerializer : ZSerializer.Internal.ZSerializer
{
    public UnityEngine.Transform bulletRot;
    ...
    public FireballZSerializer(string ZUID, string GOZUID) : base(ZUID, GOZUID)
    {       var instance = ZSerializer.ZSerialize.idMap[ZSerializer.ZSerialize.CurrentGroupID][ZUID];
         bulletRot = (UnityEngine.Transform)typeof(Fireball).GetField("bulletRot").GetValue(instance);
    ...
    {
         typeof(Fireball).GetField("bulletRot").SetValue(component, bulletRot);
