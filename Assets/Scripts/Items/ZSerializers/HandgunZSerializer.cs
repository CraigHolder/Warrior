[System.Serializable]
public sealed class HandgunZSerializer : ZSerializer.Internal.ZSerializer
{
    ...
    public HandgunZSerializer(string ZUID, string GOZUID) : base(ZUID, GOZUID)
    {       var instance = ZSerializer.ZSerialize.idMap[ZSerializer.ZSerialize.CurrentGroupID][ZUID];
         bulletRot = (UnityEngine.Transform)typeof(Handgun).GetField("bulletRot").GetValue(instance);
    ...
    {
         typeof(Handgun).GetField("bulletRot").SetValue(component, bulletRot);
