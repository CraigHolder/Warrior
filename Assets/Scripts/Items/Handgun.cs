...
public class Handgun : Item
{
    ...
    public override bool Use()
    {
        ...
        GameObject go = Instantiate<GameObject>(Resources.Load<GameObject>("9mm Bullet"), new Vector3(transform.position.x, transform.position.y+0.01f, transform.position.z) + (transform.right * 0.6f), bulletRot.rotation);
